  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(percentage: 0.7, title: 'iOS',image: 'assets/icons/flutter.png',),
        AnimatedLinearProgressIndicator(percentage: 0.9, title: 'Swift',image: 'assets/icons/dart.png'),
        ...
        AnimatedLinearProgressIndicator(percentage: 0.93, title: 'Data Science and AI',image: 'assets/icons/dart.png'),
      ],);
  }
}
