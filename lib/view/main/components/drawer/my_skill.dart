  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(percentage: 0.7, title: 'iOS',image: 'assets/icons/ioslogo.png',),
        AnimatedLinearProgressIndicator(percentage: 0.9, title: 'Swift',image: 'assets/icons/swiftLogo.png'),
        AnimatedLinearProgressIndicator(percentage: 0.6, title: 'Firebase',image: 'assets/icons/firebase.png'),
        AnimatedLinearProgressIndicator(percentage: 0.85, title: 'Postgres',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.5, title: 'Bloc',image: 'assets/icons/bloc.png'),
        AnimatedLinearProgressIndicator(percentage: 0.8, title: 'Responsive Design',image: ''),
        AnimatedLinearProgressIndicator(percentage: 0.9, title: 'Clean Architecture',image: ''),
        AnimatedLinearProgressIndicator(percentage: 0.93, title: 'Data Science and AI',image: ''),
      ],);
  }
}
